...
shinyUI(fluidPage(
  ...
  navbarPage("Dog Data",
    tabPanel("Description",
             mainPanel(
               img(src='https://media.giphy.com/media/Dkf37ayTUExQ4/giphy.gif')),
             p("Now featuring dogs! Welcome, in this app you'll be able 
               to find information regarding top dog breeds, top names, have the 
               opportunity to explore different dog breeds and compare top names,
               distribution of age, and distribution of borough of residence.")),
